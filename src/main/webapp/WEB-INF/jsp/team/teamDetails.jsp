...
<body>
    ...
    <p><a href="${pageContext.request.contextPath}/roulette/teams/edit?id=${team.id}">Edit</a></p>
    <p><a href="${pageContext.request.contextPath}/roulette/teams/delete?id=${team.id}">Delete</a></p>
